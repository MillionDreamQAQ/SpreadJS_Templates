...
class StyleCon extends Component {
  constructor(props) {
    ...
    this.hyperLinkCellType = new GC.Spread.Sheets.CellTypes.HyperLink();
          ...
          <SpreadSheets>
            ...
            >
              ...
              <Column
                dataField="country"
                width={100}
                cellType={this.comboBoxCellType}
              />
              <Column
                dataField="email"
                width={240}
                cellType={this.hyperLinkCellType}
              />
              <Column
                dataField="onJob"
                width={100}
                cellType={this.checkBoxCellType}
              />
            </Worksheet>
          </SpreadSheets>
        </div>
